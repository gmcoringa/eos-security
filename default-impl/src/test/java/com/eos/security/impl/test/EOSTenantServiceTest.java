...
public class EOSTenantServiceTest {
	...
	public void testTenantCreate() throws EOSException {
		...
		tenant.setName("Test create tenant").setDescription("Create tenant description");
	...
	public void testFindTenant() throws EOSException {
		Long tenantId = svcTenant.createTenant(
				new EOSTenant().setName("Test find tenant").setDescription("Test find description"), null,
	...
	public void testFindTenants() throws EOSException {
		...
		ids.add(svcTenant.createTenant(
				new EOSTenant().setName("Test find tenants 1").setDescription("Test find description"), null,
				getUser("test@find1.mail")).getId());
		ids.add(svcTenant.createTenant(
				new EOSTenant().setName("Test find tenants 2").setDescription("Test find description"), null,
